...
public static void main(String[] args) throws IOException {
	...
	extentReports
	.createTest("TeST1").assignAuthor("krishna")
	.assignCategory("sanity").assignDevice("edge90");

	extentReports
	.createTest("TeST2").assignAuthor("youth")
	.assignCategory("smoke").assignDevice("edge");
	
	extentReports
	.createTest("TeST2").assignAuthor("youth").assignAuthor("godavari")
	.assignCategory("smoke").assignDevice("edge");
